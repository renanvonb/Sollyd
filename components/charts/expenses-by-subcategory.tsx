    ...
    const renderChart = (isExpanded = false) => {
        ...
        return (
            <ChartContainer config={chartConfig} className="h-full w-full aspect-auto">
                ...
                >
                    <defs>
                        <pattern id={`striped-pattern-sub-${idSuffix}`} width="6" height="6" patternUnits="userSpaceOnUse" patternTransform="rotate(45)">
                            ...
                            return (
                                <g style={{ opacity, transition: 'opacity 0.3s' }}>
                                    ...
                                    <rect
                                        ...
                                        width={width}
                                        height={height}
                                        fill={`url(#striped-pattern-sub-${idSuffix})`}
                                        rx={4}
                                        ry={4}
                                    />
                                </g>
                    ...
                    >
                        ...
                        <LabelList
                            ...
                            content={(props: any) => {
                                ...
                                const subcategory = displayData[index]?.subcategory // dataKey here might different
        ...
        <Dialog>
                    ...
                    <div className="flex items-center gap-2">
                        {hasData ? (
                            <DialogTrigger asChild>
                                <CardTitle className="text-sm md:text-base font-semibold cursor-pointer">Subcategorias</CardTitle>
                            </DialogTrigger>
                        ) : (
                            <CardTitle className="text-sm md:text-base font-semibold">Subcategorias</CardTitle>
                        )}
                        {hasData && (
                            <TooltipProvider>
                                <Tooltip>
            ...
            <DialogContent className="max-w-[90vw] h-[80vh] flex flex-col">
                <DialogHeader className="flex-none pb-4">
                    <DialogTitle>Subcategorias</DialogTitle>
                </DialogHeader>
